...
router.post("/login", (0, express_async_handler_1.default)(function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_c.label) {
                ...
                case 3:
                    if (_b) {
                        ...
                        res.status(http_status_1.HTTP_BAD_REQUEST).send({ message: "Username or password is invalid!" });
                    }
                    return [2 /*return*/];
            }
        });
                ...
                case 1:
                    ...
                    if (user) {
                        res.status(http_status_1.HTTP_BAD_REQUEST)
                            .send({ message: 'User is already exist, please login!' });
                        return [2 /*return*/];
                    }
